...
# import gin.tf
from data_loader.ground_truth import cars3d, dsprites, dummy_data, mpi3d, norb,shapes3d
import hydra
from omegaconf import DictConfig

# @gin.configurable("dataset")
# @hydra.main(config_path="conf/config.yaml")
def get_named_ground_truth_data(name, data_path):
  ...
  if name == "dsprites_full":
    ...
    return dsprites.NoisyDSprites(data_path, [1, 2, 3, 4, 5])
  elif name == "scream_dsprites":
    return dsprites.ScreamDSprites(data_path, [1, 2, 3, 4, 5])

  #TODO: add data_path instead of absolute path to each dataset. Not needed at the moment.
  elif name == "smallnorb":
